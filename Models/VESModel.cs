...
namespace WebApplication1.Models
{
    ...
    public class SiteInfomatiomnDetails
    {
    ...
    public class Sites
    {
        public SiteInfomatiomnDetails Site { get; set; }
    }
    ...
    public class GLCodes
    {
        ...
        public List<SiteGLCode> SiteGLCode { get; set; }
    }
    public class PrimaryCharge
    {
        ...
        public DateTime ExpenseTypesCompositeKey { get; set; }
    ...
    public class PrimaryCharges
    {
        ...
        public List<PrimaryCharge> PrimaryCharge { get; set; }
    }
    ...
    public class VendorAccounts
    {
        ...
        public List<VendorAccount> VendorAccount { get; set; }
    }
